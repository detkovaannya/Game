#ifndef GAME_ENEMY3_H
#define GAME_ENEMY3_H
...
class Enemy3: public Enemy { //, public Observable{
public:
    Enemy3() = default;
    Enemy3(int x, int y, int heal = 300, int att = 50, int arm = 40);
    ...
    friend std::stringstream & operator<<(std::stringstream & out, const Enemy3* obj);
